...
public class WithdrawTransaction
{
    ...
    public void Print()
    {
        if (_success)
        {
            if(_reversed)
            {
                Console.WriteLine($"{_amount} was successfully withdrawn from the account, but it was reversed.");
            } else{
                Console.WriteLine($"{_amount} was successfully withdrawn from the account, and it was not reversed.");
            }
            
        }
        else
        {
            Console.WriteLine("The withdraw transaction was not successful.");
        }
        _account.Print();
    }
